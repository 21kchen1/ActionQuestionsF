 ...
 * 问题示例组件
 */
class QuestionExampleVideo extends Template {
    ...
    /**
     * 配置按钮
     * @param {QuestionExampleVideo.Config} config
     */
    setConfig(config) {
        if (config.color)
 ...
 * 配置子类
 */
QuestionExampleVideo.Config = class {
    /**
...
export default QuestionExampleVideo;